angular.module('controllers').controller('GimnasiosCiudadesController', function ($http, $scope, $location, MyService, $stateParams, $compile, $rootScope) {
    ...
    $scope.textGym = "Encuentra los gimnasios en Barcelona con los presios mÃ¡s baratos y disfruta de las actividades dirigidas" +
        " mÃ¡s divertidas como Zumba, Crosfit, Pilates, Yoga o Spinning entre muchas otras." +
        " MÃ¡s texto sobre el gym. Encuentra los gimnasios en Barcelona con los presios mÃ¡s baratos y " +
        "disfruta de las actividades dirigidas" +
        " mÃ¡s divertidas como Zumba, Crosfit, Pilates, Yoga o Spinning entre muchas otras.";
    $scope.textLength = 200;
    $scope.textMoreBtn = 'Leer mÃ¡s';
